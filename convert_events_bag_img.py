...
BAGFILE="D:/Masterarbeit_Experiment/Hall1/events_hall1.bag"
...
if __name__ == '__main__':
    ...
    number_message_contatenate = 5
    
    start_loading_frames=time.time()
    images=load_images_from_folder("D:/Masterarbeit_Experiment/Hall1/images/",number_message_contatenate)
    ...
    for top,msg,tim in bag.read_messages(TOPIC):
        ...
        if num_msgs%number_message_contatenate == 0 : 
            stoppingtime.start_time.append(time.time())    
        ...
        if num_msgs%number_message_contatenate == 0 :
            ...
            print(f"num_msgs: {num_msgs} num_picture:{num_picture*10 }")
            """
            ...
            #End, but without the displaying of the result
